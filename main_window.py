...
from app_types import WorkspaceType
from constants import DEFAULT_PREVIEW_AA, PREVIEW_AA_OPTIONS
from tabs.export_tab import ExportTab
from tabs.live_tab import LivePlaybackTab
from tabs.recorded_3d_tab import Recorded3DPlaybackTab
from tabs.signal_plot_tab import SignalPlotTab
...
class WorkspaceMainWindow(QMainWindow):
    ...
    def handle_global_aa_changed(self, anti_aliasing: str) -> None:
        ...
        for index in range(self.workspace_tabs.count()):
            ...
            if isinstance(workspace, (Recorded3DPlaybackTab, LivePlaybackTab)):
    ...
    def verify_global_anti_aliasing(self) -> None:
        ...
        for index in range(self.workspace_tabs.count()):
            workspace = self.workspace_tabs.widget(index)
            if not isinstance(workspace, (Recorded3DPlaybackTab, LivePlaybackTab)):
                continue
            previews += 1
