...
SKIP_INTERVAL = 2  # 2 = process every 2nd frame, 3 = every 3rd frame, etc.
...
def receive_new_frame(data_dict):
    order_list = ["frameNumber", "markerSetCount", "unlabeledMarkersCount", #type: ignore  # noqa F841
                  "rigidBodyCount", "skeletonCount", "imuCount", "gpioCount", "labeledMarkerCount", #type: ignore  # noqa F841
...
def receive_rigid_body_frame(new_id, position, rotation):
    # position is a list/tuple from Motive: [x, y, z]
    # rotation is a quaternion list/tuple from Motive: [qx, qy, qz, qw]
    
    # Extract components for explicit clarity
...
if __name__ == "__main__":
    ...
    optionsDict = {}
    optionsDict["clientAddress"] = "192.168.2.116"
    optionsDict["serverAddress"] = "192.168.2.155"
    ...
    # print instructions
    print("NatNet Python Client 4.5\n")
